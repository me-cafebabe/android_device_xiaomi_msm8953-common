...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci androidboot.usbconfigfs=true loop.max_part=7 androidboot.init_fatal_reboot_target=recovery printk.devkmsg=on
...
# HIDL
DEVICE_MANIFEST_FILE := $(COMMON_PATH)/manifest.xml $(COMMON_PATH)/manifest_custom.xml
